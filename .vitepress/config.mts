...
export default defineConfig({
  ...
  themeConfig: {
    nav: [
      { text: 'Home', link: '/' },
      { text: 'GitHub', link: 'https://github.com/SacDeNoeuds/model-view-demo' }
    ],
    ...
    sidebar: [
      {
        text: 'Setup',
        items: [
          { text: 'The Json Placeholder API', link: '/1-json-api.html', },
        ]
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Rendering the React & Vue apps', link: '/8-rendering-the-apps.html', },
        ]
      },
      {
        text: 'Going Further',
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/SacDeNoeuds/model-view-demo' }
    ]
  }
})
